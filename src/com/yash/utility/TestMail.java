...
public class TestMail {
	public static void main(String[] args) {
		try {
			String recipient = "sellbuddy1@gmail.com";
			...
			String htmlTextMessage = "" + "<html>"
					...
					+ "<h2 style='color:red;'>Welcome to SellBuddy Electronics</h2>" + "<p>Hey,<br>"
					+ "Thanks for singing up with SellBuddy Electronics.<br>"
