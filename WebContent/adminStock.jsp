...
<%@ page
	import="com.yash.service.impl.*, com.yash.service.*,com.yash.beans.*,java.util.*,javax.servlet.ServletOutputStream,java.io.*"%>
<!DOCTYPE html>
<html>
<head>
...
<body style="background-color: #E6F9E6;">
	...
	<div class="text-center"
		style="color: #1cc1b3; font-size: 24px; font-weight: bold;">Stock
		Products</div>
	<div class="container-fluid">
		<div class="table-responsive ">
			<table class="table table-hover table-sm">
				<thead
					style="background-color: #1cc1b3; color: white; font-size: 18px;">
					<tr>
						<th>Image</th>
						<th>ProductId</th>
						<th>Name</th>
